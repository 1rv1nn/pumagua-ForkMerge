...
estadoBebedero =(('0','No disponible'),('1','Disponible'),('2','En mantenimiento'))
...
class bebederos(models.Model):
    ...
    estado_bebedero  =  models.CharField(default='1',help_text="EstadoBebeder", max_length=1, choices=estadoBebedero)
    def __str__(self):
